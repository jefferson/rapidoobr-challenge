...
ActiveSupport::Inflector.inflections do |inflect|
  ...
  # Incontáveis
  inflect.uncountable %w( tórax tênis ônibus lápis fênix banner )

  # Irregulares
  inflect.irregular "país", "países"
  inflect.irregular "paebm", "paebm"
  inflect.irregular "vazao_maxima", "vazao_maxima"
  inflect.irregular "eoqpes", "eoqpes"
  inflect.irregular "mpism", "mpism"
  inflect.irregular "kpi", "kpi"
  inflect.irregular "classificacao_dnpm", "classificacao_dnpm"
end
